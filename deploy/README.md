# Deployment runbook: deepseek-balance
...
`ghcr.io/nickbrett1/deepseek-balance` on every push to
...
(`ghcr.io/nickbrett1/deepseek-balance:buildcache`) and
...
2. In `docker-compose.yml`, change the image to the pinned SHA:
   `image: ghcr.io/nickbrett1/deepseek-balance:<commit-sha>`
